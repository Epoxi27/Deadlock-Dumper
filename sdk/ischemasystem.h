...
public:
	...
	{
		return CALL_VIRTUAL(bool, 3U, this, pOutSize, unkPtr);
	}
...
public:
	...
	int m_nSize; // 0x0018
	int16_t nFieldSize; // 0x001C
	int16_t nStaticSize; // 0x001E
	int16_t nMetadataSize; // 0x0020

	uint8_t nAlignOf; // 0x0022
	uint8_t nBaseClassesCount; // 0x0023
...
public:
	...
	{
		return CALL_VIRTUAL(void, 2U, this, pReturnClass, szClassName);
	}

	CSchemaType* FindSchemaTypeByName(const char* szName, std::uintptr_t* pSchema)
	{
		return CALL_VIRTUAL(CSchemaType*, 4U, this, szName, pSchema);
	}

	CSchemaType* FindTypeDeclaredClass(const char* szName)
	{
		return CALL_VIRTUAL(CSchemaType*, 5U, this, szName);
	}

	CSchemaType* FindTypeDeclaredEnum(const char* szName)
	{
		return CALL_VIRTUAL(CSchemaType*, 6U, this, szName);
	}

	CSchemaClassBinding* FindRawClassBinding(const char* szName)
	{
		return CALL_VIRTUAL(CSchemaClassBinding*, 7U, this, szName);
	}
...
public:
	...
	{
		return CALL_VIRTUAL(CSchemaSystemTypeScope*, 13U, this, m_module_name, nullptr);
	}
